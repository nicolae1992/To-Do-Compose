...
import md.todo.compouse.ui.theme.PRIORITY_DROP_DOWN_HEIGHT
    ...
    Row(modifier = Modifier
        ...
        IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.content_description_dropdon_icon)
            )
        }
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(onClick = {
                expanded = false
                onPrioritySelect(Priority.HIGHT)
            }) {
